ListenToGameEvent("created_game_mode_entity",function()
	...
	gameModeEnt:SetDraftingHeroPickSelectTimeOverride( 60 )	-- Sets the amount of time players have to pick their hero. 
	...
	GameRules:SetPostGameTime( 60 )							-- Sets the amount of time players have between the game ending and the server disconnecting them. 
