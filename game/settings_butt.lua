BUTTINGS = {
	...
	UNIVERSAL_SHOP_MODE = 0,            -- 0 = normal, 1 = you can buy every item in every shop (secret/side/base).
	...
	GOLD_PER_MINUTE = 100,               -- (default =  95) passive gold
	...
	TIME_UNTIL_AGH_SHARD = 15, 			-- Time until aghanim shard in minutes
	...
	ALT_WINNING = 1,                    -- 0 = normal, 1 = use these alternative winning conditions
	ALT_KILL_LIMIT = 900,               -- Kills for alternative winnning
	ALT_TIME_LIMIT = 3,                -- Timer for alternative winning
